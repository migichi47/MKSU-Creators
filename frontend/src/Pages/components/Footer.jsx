...
export function Footer() {
  ...
  return (
    <div className="relative w-full bottom-0 border-t backdrop-blur-xl border-tertiary/20 dark:border-neutral/20 text-center pt-6 pb-8 flex flex-col gap-4 mt-10 text-xs">
